...
var _user$project$AppPorts$setSessionStorage = _elm_lang$core$Native_Platform.outgoingPort(
	'setSessionStorage',
	function (v) {
		return [v._0, v._1];
	});
var _user$project$AppPorts$getSessionStorage = _elm_lang$core$Native_Platform.outgoingPort(
	'getSessionStorage',
	function (v) {
		return v;
	});
var _user$project$AppPorts$getSessionStorageResult = _elm_lang$core$Native_Platform.incomingPort(
	'getSessionStorageResult',
	A2(
		_elm_lang$core$Json_Decode$andThen,
		function (x0) {
			return A2(
...
var _user$project$Login$jwtData = function (_) {
	return _.jwtData;
};
var _user$project$Login$isLogged = function (model) {
	return _elm_lang$core$Native_Utils.eq(model.jwtData, '') ? _elm_lang$core$Task$fail('not connected') : A2(
		_elm_lang$core$Task$map,
		function (d) {
			return A3(_rluiten$elm_date_extra$Date_Extra_Compare$is, _rluiten$elm_date_extra$Date_Extra_Compare$Before, d, model.jwtExpires);
		},
...
var _user$project$Login$init = A2(
	...
	{
		jwtData: '',
		jwtExpires: _elm_lang$core$Date$fromTime(0),
		userName: '',
		password: '',
		isLoading: false,
	...
	{
		ctor: '::',
		_0: _user$project$AppPorts$getSessionStorage('jwtData'),
		_1: {
			ctor: '::',
			_0: _user$project$AppPorts$getSessionStorage('jwtExpires'),
			_1: {ctor: '[]'}
		}
	});
var _user$project$Login$Model = F6(
	function (a, b, c, d, e, f) {
		return {jwtData: a, jwtExpires: b, userName: c, password: d, isLoading: e, errorMessage: f};
	});
var _user$project$Login$LoginResponse = F2(
	function (a, b) {
		return {jwtData: a, jwtExpires: b};
	});
var _user$project$Login$decodeLoginResponse = A3(
	_elm_lang$core$Json_Decode$map2,
	_user$project$Login$LoginResponse,
	A2(_elm_lang$core$Json_Decode$field, 'token', _elm_lang$core$Json_Decode$string),
	A2(_elm_lang$core$Json_Decode$field, 'expires', _elm_lang$core$Json_Decode$string));
var _user$project$Login$GetSessionStorage = function (a) {
	return {ctor: 'GetSessionStorage', _0: a};
};
var _user$project$Login$subscriptions = function (model) {
	return _user$project$AppPorts$getSessionStorageResult(_user$project$Login$GetSessionStorage);
};
var _user$project$Login$ResponseMsg = function (a) {
	return {ctor: 'ResponseMsg', _0: a};
};
	...
	function (msg, model) {
		...
		switch (_p0.ctor) {
			case 'Login':
				...
				var request = A3(_elm_lang$http$Http$post, '/api/auth/login', body, _user$project$Login$decodeLoginResponse);
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{userName: '', password: '', isLoading: true, errorMessage: _elm_lang$core$Maybe$Nothing}),
					_1: A2(_elm_lang$http$Http$send, _user$project$Login$ResponseMsg, request)
				};
			case 'Username':
				return {
					ctor: '_Tuple2',
			...
			case 'ResponseMsg':
				if (_p0._0.ctor === 'Ok') {
					var _p2 = _p0._0._0;
					var dateAttempt = _elm_lang$core$Date$fromString(_p2.jwtExpires);
					var _p1 = dateAttempt;
					if (_p1.ctor === 'Ok') {
						return A2(
							_elm_lang$core$Platform_Cmd_ops['!'],
							_elm_lang$core$Native_Utils.update(
								model,
								{jwtData: _p2.jwtData, jwtExpires: _p1._0, isLoading: false}),
							{
								ctor: '::',
								_0: _user$project$AppPorts$setSessionStorage(
									{ctor: '_Tuple2', _0: 'jwtData', _1: _p2.jwtData}),
								_1: {
									ctor: '::',
									_0: _user$project$AppPorts$setSessionStorage(
										{ctor: '_Tuple2', _0: 'jwtExpires', _1: _p2.jwtExpires}),
									_1: {ctor: '[]'}
								}
							});
					} else {
						return {
							...
							_0: _elm_lang$core$Native_Utils.update(
								model,
								{
									errorMessage: _elm_lang$core$Maybe$Just('Ouch ! Something went wrong.'),
									isLoading: false
								}),
							_1: _elm_lang$core$Platform_Cmd$none
						};
			...
			default:
				...
				switch (_p3) {
					...
					case 'jwtExpires':
						var dateAttempt = _elm_lang$core$Date$fromString(_p5);
						var _p4 = dateAttempt;
						if (_p4.ctor === 'Ok') {
							return {
								ctor: '_Tuple2',
...
var _user$project$Login$loginForm = function (model) {
	var buttonClass = model.isLoading ? 'button is-link is-loading' : 'button is-link';
	return A2(
		_elm_lang$html$Html$section,
		{
			ctor: '::',
			_0: A2(_elm_lang$html$Html_Attributes$attribute, 'class', 'section'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: A2(
				...
				{
					ctor: '::',
					_0: A2(_elm_lang$html$Html_Attributes$attribute, 'class', 'container'),
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$style(
							{
								ctor: '::',
								_0: {ctor: '_Tuple2', _0: 'maxWidth', _1: '25rem'},
								_1: {ctor: '[]'}
							}),
						_1: {ctor: '[]'}
					}
				},
				{
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: A2(_elm_lang$html$Html_Attributes$attribute, 'class', 'title'),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
						...
						_0: A2(
							...
							},
							{
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: A2(_elm_lang$html$Html_Attributes$attribute, 'class', 'field'),
										_1: {ctor: '[]'}
									},
									{
										ctor: '::',
										_0: A2(
											...
											{
												ctor: '::',
												_0: A2(_elm_lang$html$Html_Attributes$attribute, 'class', 'control'),
												_1: {ctor: '[]'}
											},
											{
												ctor: '::',
												_0: A2(
													_elm_lang$html$Html$input,
													{
														...
														_1: {
															ctor: '::',
															_0: A2(_elm_lang$html$Html_Attributes$attribute, 'class', 'input'),
															_1: {
																ctor: '::',
								...
								_1: {
									...
									_1: {
										...
										_0: A2(
											...
											{
												ctor: '::',
												_0: A2(_elm_lang$html$Html_Attributes$attribute, 'class', 'help is-danger'),
												_1: {ctor: '[]'}
											},
											{
												ctor: '::',
												_0: _elm_lang$html$Html$text(
													A2(_elm_lang$core$Maybe$withDefault, '', model.errorMessage)),
												_1: {ctor: '[]'}
											}),
										_1: {
											ctor: '::',
											_0: A2(
												...
												{
													ctor: '::',
													_0: A2(_elm_lang$html$Html_Attributes$attribute, 'class', 'is-grouped'),
													_1: {ctor: '[]'}
												},
												{
													ctor: '::',
													_0: A2(
														...
														},
														{
															...
															_0: A2(
																...
																{
																	ctor: '::',
																	_0: A2(_elm_lang$html$Html_Attributes$attribute, 'class', buttonClass),
																	_1: {ctor: '[]'}
																},
																{
																	ctor: '::',
...
var _user$project$Requests$get = F4(
	function (msg, url, auth, decoder) {
		var req = _elm_lang$http$Http$request(
			{
				...
				headers: {
					...
					_0: A2(
						...
						'Authorization',
						A2(_elm_lang$core$Basics_ops['++'], 'Bearer ', auth)),
					_1: {ctor: '[]'}
				},
				url: url,
				body: _elm_lang$http$Http$emptyBody,
...
var _user$project$ServerDetails$vmwareForm = function (server) {
	return A2(
		_elm_lang$html$Html$form,
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				},
				{
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class('field-label is-normal'),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
												...
												_0: A2(
													_elm_lang$html$Html$input,
													{
														...
														_1: {
															...
															_1: {
																ctor: '::',
																_0: _elm_lang$html$Html_Attributes$defaultValue(server.name),
																_1: {ctor: '[]'}
															}
														}
													},
						...
						_0: A2(
							...
							},
							{
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html$text('vCenter'),
										_1: {ctor: '[]'}
									}),
								_1: {ctor: '[]'}
							}),
													...
													_0: A2(
														_elm_lang$html$Html$input,
														{
															...
															_1: {
																...
																_1: {
																	ctor: '::',
																	_0: _elm_lang$html$Html_Attributes$defaultValue(server.ip),
																	_1: {
																		ctor: '::',
																		_0: _elm_lang$html$Html_Attributes$placeholder('Ip or DNS'),
																		_1: {ctor: '[]'}
																	}
																}
															}
																...
																_1: {
																	...
																	_1: {
																		...
																		_0: _elm_lang$html$Html_Attributes$defaultValue(
																			A2(_elm_lang$core$Maybe$withDefault, '', server.username)),
																		_1: {
																			ctor: '::',
																...
																_elm_lang$html$Html$input,
																{
																	...
																	_1: {
																		...
																		_1: {
																			ctor: '::',
																			_0: _elm_lang$html$Html_Attributes$defaultValue(
																				A2(_elm_lang$core$Maybe$withDefault, '', server.password)),
																			_1: {
																				ctor: '::',
...
var _user$project$ServerDetails$windowsForm = function (server) {
	return A2(
		_elm_lang$html$Html$form,
		{ctor: '[]'},
		{
...
var _user$project$ServerDetails$add = A2(
	_elm_lang$html$Html$section,
	{
		ctor: '::',
						...
						_0: A2(
							...
							},
							{
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html$text('Add new server'),
										_1: {ctor: '[]'}
									}),
								_1: {ctor: '[]'}
							}),
											...
											_0: A2(
												...
												},
												{
													...
													_0: A2(
														...
														{
															ctor: '::',
															_0: _elm_lang$html$Html$text('Server type'),
															_1: {ctor: '[]'}
														}),
													_1: {ctor: '[]'}
												}),
												...
												_0: A2(
													...
													},
													{
														...
														_0: A2(
															...
															{
																ctor: '::',
																_0: _elm_lang$html$Html_Attributes$class('field is-narrow'),
																_1: {ctor: '[]'}
															},
															{
																ctor: '::',
																					...
																					{ctor: '[]'},
																					{
																						...
																						_1: {
																							...
																							_0: A2(
																								...
																								{
																									ctor: '::',
																									_0: _elm_lang$html$Html$text('Windows'),
																									_1: {ctor: '[]'}
																								}),
																							_1: {
																								ctor: '::',
																								_0: A2(
																									...
																									{
																										ctor: '::',
																										_0: _elm_lang$html$Html$text('VMware'),
																										_1: {ctor: '[]'}
																									}),
																								_1: {ctor: '[]'}
																							}
...
var _user$project$ServerDetails$details = function (_p0) {
	var _p1 = _p0;
	if (_p1.isFetching) {
		return A2(
			_elm_lang$html$Html$div,
			{
				...
				_0: _elm_lang$html$Html_Attributes$style(
					{
						ctor: '::',
						_0: {ctor: '_Tuple2', _0: 'marginBottom', _1: '1.5rem'},
						_1: {ctor: '[]'}
					}),
				_1: {ctor: '[]'}
			},
		...
		if (_p2.ctor === 'Nothing') {
			return A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('server not found !'),
					_1: {ctor: '[]'}
				});
		} else {
			var _p3 = function () {
				var _p4 = _p2._0;
				if (_p4.ctor === 'WindowsServer') {
					var _p5 = _p4._0;
					return {
						ctor: '_Tuple3',
						_0: _user$project$ServerDetails$windowsForm(_p5),
						_1: _p5.name,
						_2: _p5.type_
					};
				} else {
					...
					return {
						ctor: '_Tuple3',
						_0: _user$project$ServerDetails$vmwareForm(_p6),
						_1: _p6.name,
						_2: _p6.type_
					};
				}
...
var _user$project$ServerDetails$update = F2(
	function (msg, model) {
		var _p7 = msg;
		if (_p7._0.ctor === 'Ok') {
			return {
				...
				_0: _elm_lang$core$Native_Utils.update(
					model,
					{
						server: _elm_lang$core$Maybe$Just(_p7._0._0),
						isFetching: false
					}),
				_1: _elm_lang$core$Platform_Cmd$none
			};
			...
			return {
				...
				_0: _elm_lang$core$Native_Utils.update(
					model,
					{server: _elm_lang$core$Maybe$Nothing, isFetching: false}),
				_1: _elm_lang$core$Platform_Cmd$none
			};
		}
	});
var _user$project$ServerDetails$init = {server: _elm_lang$core$Maybe$Nothing, isFetching: true};
var _user$project$ServerDetails$Model = F2(
	function (a, b) {
		return {server: a, isFetching: b};
	});
var _user$project$ServerDetails$LooseServer = F7(
	function (a, b, c, d, e, f, g) {
		return {id_: a, name: b, ip: c, port_: d, type_: e, username: f, password: g};
	});
var _user$project$ServerDetails$VMwareServer = function (a) {
	return {ctor: 'VMwareServer', _0: a};
};
var _user$project$ServerDetails$decodeVMwareServer = function () {
	var toVMwareServer = F9(
		function (id_, name, ip, port_, type_, username, password, thumbPrint, vms) {
			return {id_: id_, name: name, ip: ip, port_: port_, type_: type_, username: username, password: password, thumbPrint: thumbPrint, vms: vms};
		});
	return A2(
		_elm_lang$core$Json_Decode$map,
		_user$project$ServerDetails$VMwareServer,
		A4(
								...
								A3(
									...
									A3(
										...
										A3(
											...
											'id',
											_elm_lang$core$Json_Decode$string,
											_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(toVMwareServer)))))))))));
}();
var _user$project$ServerDetails$WindowsServer = function (a) {
	return {ctor: 'WindowsServer', _0: a};
};
var _user$project$ServerDetails$decodeWindowsServer = function () {
	var toWindowsServer = F7(
		function (id_, name, ip, port_, type_, username, password) {
			return {id_: id_, name: name, ip: ip, port_: port_, type_: type_, username: username, password: password};
		});
	return A2(
		_elm_lang$core$Json_Decode$map,
		_user$project$ServerDetails$WindowsServer,
		A3(
			_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
			'password',
			_elm_lang$core$Json_Decode$nullable(_elm_lang$core$Json_Decode$string),
						...
						A3(
							...
							A3(
								...
								A3(
									...
									'id',
									_elm_lang$core$Json_Decode$string,
									_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(toWindowsServer)))))))));
}();
var _user$project$ServerDetails$decodeServerType = function (type_) {
	var _p8 = type_;
	switch (_p8) {
		case 'Windows':
			return _user$project$ServerDetails$decodeWindowsServer;
		case 'VMware':
			return _user$project$ServerDetails$decodeVMwareServer;
		default:
			return _elm_lang$core$Json_Decode$fail(
				A2(_elm_lang$core$Basics_ops['++'], 'Unknown server type: ', type_));
	}
};
var _user$project$ServerDetails$decodeServerResponse = A2(
	_elm_lang$core$Json_Decode$andThen,
	_user$project$ServerDetails$decodeServerType,
	A2(_elm_lang$core$Json_Decode$field, 'type', _elm_lang$core$Json_Decode$string));
var _user$project$ServerDetails$ServerResponse = function (a) {
	return {ctor: 'ServerResponse', _0: a};
};
var _user$project$ServerDetails$getServer = F2(
	function (id, auth) {
		return A4(
			_user$project$Requests$get,
			_user$project$ServerDetails$ServerResponse,
			A2(_elm_lang$core$Basics_ops['++'], '/api/servers/', id),
			auth,
			_user$project$ServerDetails$decodeServerResponse);
	});

var _user$project$Servers$update = F2(
	function (msg, model) {
		var _p0 = msg;
		if (_p0.ctor === 'ServersListResponse') {
			if (_p0._0.ctor === 'Ok') {
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{servers: _p0._0._0, isFetching: false}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			} else {
				return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
...
var _user$project$Servers$init = {
	servers: {ctor: '[]'},
	isFetching: true
};
var _user$project$Servers$Model = F2(
	function (a, b) {
		return {servers: a, isFetching: b};
	});
var _user$project$Servers$Server = F5(
	function (a, b, c, d, e) {
		return {id_: a, name: b, ip: c, port_: d, type_: e};
	});
var _user$project$Servers$decodeServersResponse = _elm_lang$core$Json_Decode$list(
	A6(
		_elm_lang$core$Json_Decode$map5,
		_user$project$Servers$Server,
		...
		A2(_elm_lang$core$Json_Decode$field, 'type', _elm_lang$core$Json_Decode$string)));
var _user$project$Servers$ChangeURL = function (a) {
	return {ctor: 'ChangeURL', _0: a};
};
var _user$project$Servers$summaryLine = function (server) {
	return {
		ctor: '_Tuple2',
		_0: server.id_,
		_1: A2(
				...
				_1: {
							...
							_0: A2(
								_elm_lang$html$Html$a,
								{
									...
									_0: _elm_lang$html$Html_Events$onClick(
										_user$project$Servers$ChangeURL(
											A2(_elm_lang$core$Basics_ops['++'], '/servers/', server.id_))),
									_1: {ctor: '[]'}
								},
								{
									ctor: '::',
									_0: _elm_lang$html$Html$text(server.name),
									_1: {ctor: '[]'}
								}),
							_1: {ctor: '[]'}
						}),
					_1: {
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text(server.ip),
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html$text(server.type_),
									_1: {ctor: '[]'}
								}),
							_1: {ctor: '[]'}
						}
...
var _user$project$Servers$summary = function (model) {
		...
		},
		{
							...
							_0: A2(
								...
								{ctor: '[]'},
								{
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: A2(_elm_lang$html$Html_Attributes$attribute, 'title', 'Remove'),
											_1: {ctor: '[]'}
										},
										{
											ctor: '::',
							...
							_1: {
								...
								_1: {
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html$text('IP / Host'),
											_1: {ctor: '[]'}
										}),
									_1: {
										ctor: '::',
			...
			_1: {
				...
				_0: A3(
					...
					'tbody',
					{ctor: '[]'},
					A2(_elm_lang$core$List$map, _user$project$Servers$summaryLine, model.servers)),
				_1: {ctor: '[]'}
			}
		});
};
var _user$project$Servers$ServersListResponse = function (a) {
	return {ctor: 'ServersListResponse', _0: a};
};
var _user$project$Servers$getServers = function (auth) {
	return A4(_user$project$Requests$get, _user$project$Servers$ServersListResponse, '/api/servers', auth, _user$project$Servers$decodeServersResponse);
};

var _user$project$App$isActionActive = F2(
	function (pathname, compareRoute) {
		var _p0 = pathname;
		if (_p0.ctor === 'Nothing') {
			return '';
		} else {
			return _elm_lang$core$Native_Utils.eq(_p0._0.action, compareRoute) ? ' is-active' : '';
		}
	});
var _user$project$App$isRouteActive = F2(
	function (pathname, compareRoute) {
		var _p1 = pathname;
		if (_p1.ctor === 'Nothing') {
			return '';
		} else {
			return _elm_lang$core$Native_Utils.eq(_p1._0.route, compareRoute) ? ' is-active' : '';
		}
	});
var _user$project$App$Model = F5(
	function (a, b, c, d, e) {
		return {location: a, servers: b, currentServer: c, isLoggedIn: d, loginModel: e};
	});
var _user$project$App$RouteDetails = F2(
	function (a, b) {
		return {route: a, action: b};
	});
var _user$project$App$ServersAdd = {ctor: 'ServersAdd'};
var _user$project$App$ServersBackup = function (a) {
	return {ctor: 'ServersBackup', _0: a};
};
var _user$project$App$ServersDetails = function (a) {
	return {ctor: 'ServersDetails', _0: a};
};
var _user$project$App$ServersSummary = {ctor: 'ServersSummary'};
var _user$project$App$serversParser = _evancz$url_parser$UrlParser$oneOf(
	{
		ctor: '::',
		_0: A2(_evancz$url_parser$UrlParser$map, _user$project$App$ServersSummary, _evancz$url_parser$UrlParser$top),
		_1: {
			ctor: '::',
			_0: A2(
				_evancz$url_parser$UrlParser$map,
				_user$project$App$ServersAdd,
				_evancz$url_parser$UrlParser$s('add')),
			_1: {
				ctor: '::',
				_0: A2(
					_evancz$url_parser$UrlParser$map,
					_user$project$App$ServersDetails,
					A2(_evancz$url_parser$UrlParser_ops['</>'], _evancz$url_parser$UrlParser$string, _evancz$url_parser$UrlParser$top)),
				_1: {
					ctor: '::',
					_0: A2(
						_evancz$url_parser$UrlParser$map,
						_user$project$App$ServersBackup,
						A2(
							_evancz$url_parser$UrlParser_ops['</>'],
							_evancz$url_parser$UrlParser$string,
							_evancz$url_parser$UrlParser$s('backup'))),
					_1: {ctor: '[]'}
				}
			}
		}
	});
var _user$project$App$backupsParser = _evancz$url_parser$UrlParser$oneOf(
	{
		ctor: '::',
		_0: A2(_evancz$url_parser$UrlParser$map, _user$project$App$ServersSummary, _evancz$url_parser$UrlParser$top),
		_1: {
...
var _user$project$App$NotFoundRoute = {ctor: 'NotFoundRoute'};
var _user$project$App$CalendarRoute = {ctor: 'CalendarRoute'};
var _user$project$App$ServersRoute = {ctor: 'ServersRoute'};
var _user$project$App$BackupsRoute = {ctor: 'BackupsRoute'};
var _user$project$App$Home = {ctor: 'Home'};
var _user$project$App$parser = _evancz$url_parser$UrlParser$parsePath(
	A2(
		_evancz$url_parser$UrlParser$map,
		_user$project$App$RouteDetails,
		_evancz$url_parser$UrlParser$oneOf(
			{
				ctor: '::',
				_0: A2(
					_evancz$url_parser$UrlParser_ops['</>'],
					A2(_evancz$url_parser$UrlParser$map, _user$project$App$Home, _evancz$url_parser$UrlParser$top),
					A2(_evancz$url_parser$UrlParser$map, _user$project$App$None, _evancz$url_parser$UrlParser$top)),
				_1: {
					ctor: '::',
					_0: A2(
						_evancz$url_parser$UrlParser_ops['</>'],
						A2(
							_evancz$url_parser$UrlParser$map,
							_user$project$App$BackupsRoute,
							_evancz$url_parser$UrlParser$s('backups')),
						_user$project$App$backupsParser),
					_1: {
						ctor: '::',
						_0: A2(
							_evancz$url_parser$UrlParser_ops['</>'],
							A2(
								_evancz$url_parser$UrlParser$map,
								_user$project$App$ServersRoute,
								_evancz$url_parser$UrlParser$s('servers')),
							_user$project$App$serversParser),
						_1: {
							ctor: '::',
							_0: A2(
								_evancz$url_parser$UrlParser_ops['</>'],
								A2(
									_evancz$url_parser$UrlParser$map,
									_user$project$App$CalendarRoute,
...
var _user$project$App$ServerDetailsMsg = function (a) {
	return {ctor: 'ServerDetailsMsg', _0: a};
};
var _user$project$App$ServersMsg = function (a) {
	return {ctor: 'ServersMsg', _0: a};
};
var _user$project$App$routeCmd = function (model) {
	var _p2 = model.location;
	if (_p2.ctor === 'Nothing') {
		return _elm_lang$core$Platform_Cmd$none;
	} else {
		var _p3 = _p2._0.route;
		if (_p3.ctor === 'ServersRoute') {
			var auth = _user$project$Login$jwtData(model.loginModel);
			var _p4 = _p2._0.action;
			switch (_p4.ctor) {
				case 'ServersSummary':
					return A2(
						_elm_lang$core$Platform_Cmd$map,
						_user$project$App$ServersMsg,
						_user$project$Servers$getServers(auth));
				case 'ServersDetails':
					return A2(
						_elm_lang$core$Platform_Cmd$map,
						_user$project$App$ServerDetailsMsg,
						A2(_user$project$ServerDetails$getServer, _p4._0, auth));
				default:
					return _elm_lang$core$Platform_Cmd$none;
			}
		} else {
...
var _user$project$App$content = function (model) {
	var _p5 = model.location;
	if (_p5.ctor === 'Nothing') {
		return A2(
			_elm_lang$html$Html$section,
			{
		...
		var content = function () {
			var _p6 = _p5._0.route;
			if (_p6.ctor === 'ServersRoute') {
				var _p7 = _p5._0.action;
				switch (_p7.ctor) {
					case 'ServersAdd':
						return _user$project$ServerDetails$add;
					case 'ServersDetails':
						return _user$project$ServerDetails$details(model.currentServer);
					default:
						return A2(
							_elm_lang$html$Html$map,
							_user$project$App$ServersMsg,
							_user$project$Servers$summary(model.servers));
				}
			} else {
				return A2(
					_elm_lang$html$Html$div,
...
var _user$project$App$LoggedInMsg = function (a) {
...
var _user$project$App$init = function (location) {
	var _p8 = _user$project$Login$init;
	var loginModel = _p8._0;
	var loginCmd = _p8._1;
	var model = {
		location: _user$project$App$parser(location),
		servers: _user$project$Servers$init,
		currentServer: _user$project$ServerDetails$init,
		isLoggedIn: false,
	...
	return A2(
		...
		{
			ctor: '::',
			_0: A2(_elm_lang$core$Platform_Cmd$map, _user$project$App$LoginMsg, loginCmd),
			_1: {ctor: '[]'}
		});
};
var _user$project$App$subscriptions = function (model) {
	return A2(
		...
		_user$project$Login$subscriptions(model.loginModel));
};
		...
		switch (_p9.ctor) {
			case 'NewLocation':
				var newModel = _elm_lang$core$Native_Utils.update(
					model,
					{
						location: _user$project$App$parser(_p9._0)
					});
				var command = _user$project$App$routeCmd(newModel);
			...
			case 'ServersMsg':
				var _p10 = A2(_user$project$Servers$update, _p9._0, model.servers);
				var serversModel = _p10._0;
				var serversCmd = _p10._1;
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{servers: serversModel}),
					_1: A2(_elm_lang$core$Platform_Cmd$map, _user$project$App$ServersMsg, serversCmd)
				};
			case 'ServerDetailsMsg':
				var _p11 = A2(_user$project$ServerDetails$update, _p9._0, model.currentServer);
				var serverModel = _p11._0;
				var serverCmd = _p11._1;
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{currentServer: serverModel}),
					_1: A2(_elm_lang$core$Platform_Cmd$map, _user$project$App$ServerDetailsMsg, serverCmd)
				};
			case 'LoginMsg':
				var _p12 = A2(_user$project$Login$update, _p9._0, model.loginModel);
				var loginModel = _p12._0;
				var loginCmd = _p12._1;
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					_elm_lang$core$Native_Utils.update(
						model,
						{loginModel: loginModel}),
					{
						...
						_1: {
							...
							_0: A2(
								_elm_lang$core$Task$attempt,
								_user$project$App$LoggedInMsg,
								_user$project$Login$isLogged(loginModel)),
							_1: {ctor: '[]'}
						}
					});
			default:
				if (_p9._0.ctor === 'Err') {
					...
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{isLoggedIn: _p9._0._0}),
						_1: _user$project$App$routeCmd(model)
					};
				}
		}
	});
var _user$project$App$ChangeURL = function (a) {
	return {ctor: 'ChangeURL', _0: a};
};
var _user$project$App$navbar = function (model) {
	var isA = _user$project$App$isRouteActive(model.location);
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
							...
							_0: A2(
								_elm_lang$html$Html$li,
								{
									...
									_0: _elm_lang$html$Html_Attributes$class(
										isA(_user$project$App$BackupsRoute)),
									_1: {ctor: '[]'}
								},
								{
									ctor: '::',
									_0: A2(
										_elm_lang$html$Html$a,
										{
											ctor: '::',
											_0: _elm_lang$html$Html_Events$onClick(
												_user$project$App$ChangeURL('/backups')),
											_1: {ctor: '[]'}
										},
										{
											ctor: '::',
											_0: _elm_lang$html$Html$text('Backups'),
											_1: {ctor: '[]'}
										}),
									_1: {ctor: '[]'}
								}),
							_1: {
								...
								_0: A2(
									_elm_lang$html$Html$li,
									{
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$class(
											isA(_user$project$App$ServersRoute)),
										_1: {ctor: '[]'}
									},
									{
										ctor: '::',
										_0: A2(
											_elm_lang$html$Html$a,
											{
												ctor: '::',
												_0: _elm_lang$html$Html_Events$onClick(
													_user$project$App$ChangeURL('/servers')),
												_1: {ctor: '[]'}
											},
											{
												ctor: '::',
												_0: _elm_lang$html$Html$text('Servers'),
												_1: {ctor: '[]'}
											}),
										_1: {ctor: '[]'}
									}),
								_1: {
									...
									_0: A2(
										_elm_lang$html$Html$li,
										{
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$class(
												isA(_user$project$App$CalendarRoute)),
											_1: {ctor: '[]'}
										},
										{
											ctor: '::',
											_0: A2(
												_elm_lang$html$Html$a,
												{
													ctor: '::',
													_0: _elm_lang$html$Html_Events$onClick(
														_user$project$App$ChangeURL('/calendar')),
													_1: {ctor: '[]'}
												},
												{
													ctor: '::',
...
var _user$project$App$subNavbar = function (model) {
	var isA = _user$project$App$isActionActive(model.location);
	var _p13 = model.location;
	if (_p13.ctor === 'Nothing') {
		return A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html$text('Choose a tab'),
				_1: {ctor: '[]'}
			});
	} else {
		var _p14 = _p13._0.route;
		if (_p14.ctor === 'ServersRoute') {
			return A2(
				_elm_lang$html$Html$div,
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('navbar-tabs'),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
						...
						_elm_lang$html$Html$a,
						{
							...
							_0: _elm_lang$html$Html_Attributes$class(
								A2(
									_elm_lang$core$Basics_ops['++'],
									'navbar-item is-tab',
									isA(_user$project$App$ServersSummary))),
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html_Events$onClick(
									_user$project$App$ChangeURL('/servers')),
							...
							_elm_lang$html$Html$a,
							{
								...
								_0: _elm_lang$html$Html_Attributes$class(
									A2(
										_elm_lang$core$Basics_ops['++'],
										'navbar-item is-tab',
										isA(_user$project$App$ServersAdd))),
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html_Events$onClick(
										_user$project$App$ChangeURL('/servers/add')),
									_1: {ctor: '[]'}
								}
							},
							{
						...
						_0: A2(
							...
							},
							{
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$class('fa fa-level-up'),
										_1: {ctor: '[]'}
									},
									{ctor: '[]'}),
								_1: {ctor: '[]'}
...
var _user$project$App$view = function (model) {
	return model.isLoggedIn ? A2(
		...
		{ctor: '[]'},
		{
				...
				},
				{
					...
					_1: {
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: A2(_elm_lang$html$Html_Lazy$lazy, _user$project$App$navbar, model),
								_1: {ctor: '[]'}
							}),
						_1: {ctor: '[]'}
					}
			...
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('navbar has-shadow'),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
						_0: A2(
							...
							{
								ctor: '::',
								_0: A2(_elm_lang$html$Html_Lazy$lazy, _user$project$App$subNavbar, model),
								_1: {ctor: '[]'}
							}),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
					_0: A2(_elm_lang$html$Html_Lazy$lazy, _user$project$App$content, model),
					_1: {ctor: '[]'}
				}
			}
		}) : A2(
		_elm_lang$html$Html$map,
		_user$project$App$LoginMsg,
		_user$project$Login$loginForm(model.loginModel));
};
var _user$project$App$NewLocation = function (a) {
	return {ctor: 'NewLocation', _0: a};
};
var _user$project$App$main = A2(
	_elm_lang$navigation$Navigation$program,
	_user$project$App$NewLocation,
